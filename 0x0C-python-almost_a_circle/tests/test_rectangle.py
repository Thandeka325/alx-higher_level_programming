...
class TestRectangle(unittest.TestCase):
    ...
    def tearDown(self):
        """Cleans up after each test_method is ran.
        """
        pass
    ...
    def test_A_class(self):
        """Tests the Rectangle class type.
        """
    ...
    def test_C_constructor_no_args(self):
        """Tests for the constructor signature.
        """
...
given"
    ...
    def test_D_instantiation_positional(self):
        """Tests for positional instantiation.
        """
    ...
    def test_I_area_no_args(self):
        """Tests the area() method signature.
        """
        r = Rectangle(5, 6)
        with self.assertRaises(TypeError) as e:
            Rectangle.area()
    ...
    def test_I_area(self):
        """Tests the area() method compuation.
        """
        r = Rectangle(5, 6)
...
"""
    ...
    def test_K_str_no_args(self):
        """Tests the __str__() method signature.
        """
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.__str__()
    ...
    def test_K_str(self):
        """Tests the __str__() method return.
        """
        r = Rectangle(5, 2)
    ...
    def test_L_update_no_args(self):
        """Tests the update() method signature.
        """
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.update()
    ...
    def test_L_update_args(self):
        """Tests the update() postional args.
        """
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        """Tests the update() positional arg fubars.
        """
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        """Tests the to_dictionary() signature.
        """
        with self.assertRaises(TypeError) as e:
