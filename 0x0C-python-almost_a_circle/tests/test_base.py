...
class TestBase(unittest.TestCase):
    ...
    def test_D_constructor_args_2(self):
        """Tests constructor signature using 2 notself args.
        """
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_F_id_synced_more(self):
        """Tests for sync between class and instance id.
        """
        b = Base()
        b = Base("Foo")
        b = Base(98)
    ...
    def test_G_id_keyword(self):
        """Tests if id is passed as a keyword arg.
        """
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
    ...
    def test_H_to_json_string(self):
        """Tests the to_json_string() signature.
        """
        with self.assertRaises(TypeError) as e:
            Base.to_json_string()
